package net.samir.tp3_hospital.security.service;

import lombok.AllArgsConstructor;
import net.samir.tp3_hospital.security.entities.AppRole;
import net.samir.tp3_hospital.security.entities.AppUser;
import net.samir.tp3_hospital.security.repo.AppRoleRepository;
import net.samir.tp3_hospital.security.repo.AppUserRepository;
